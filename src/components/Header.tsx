  ...
  return (
    <nav className="bg-black text-white sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4 w-full flex flex-wrap items-center justify-between gap-2 sm:gap-3">
        <h1 className="text-base sm:text-xl font-bold flex items-center font-baskerville gap-3 sm:gap-5 text-[#cdad7d]">
          ...
          <span className="hidden md:inline">REMANESCENTES</span>
        </h1>

        <div className="flex items-center flex-wrap gap-2 sm:gap-4 md:gap-6">
          <Link
            to="/"
            className="hover:text-blue-400 transition-colors text-xs sm:text-sm md:text-base text-[#cdad7d] font-baskerville font-bold"
          >
            INÍCIO
          </Link>
          <Link
