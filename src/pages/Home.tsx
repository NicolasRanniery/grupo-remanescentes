...
export default function Home() {
  return (
    <section className="flex flex-col items-center justify-center text-center px-4 flex-1 bg-[#e9ded2]">
      <p className="font-texgyretermes text-2xl md:text-2xl text-[#303030]">Seja bem vindo ao</p>
      <h1 className="text-6xl md:text-8xl mb-4 text-[#303030] font-texgyretermes underline decoration-2 underline-offset-8 -mt-3 md:-mt-5">
        Remanescentes
      </h1>
